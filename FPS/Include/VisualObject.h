...
public: 
	...
	virtual int getObjectSerialNumber() {return objectSerialNumber;}

	virtual VisualObject* getChildByID(int objectSerialNumber);
	...
	virtual void setTextureName(std::string input) { this->textureFileName = input; };
